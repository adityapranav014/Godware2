            ...
            <nav className="hidden md:flex items-center gap-1 lg:gap-2">
              {NAV_LINKS.map((link) => (
                <button
                  ...
                  className={`relative px-4 lg:px-6 py-2.5 rounded-full font-medium text-sm lg:text-base transition-all duration-300 ${activeSection === link.name
                    ? "text-gold-500"
            ...
            <nav className="flex-1 flex flex-col justify-center px-6 gap-3">
              {NAV_LINKS.map((link) => (
                <button
                  ...
                  className={`relative w-full text-left py-5 px-6 rounded-2xl text-2xl font-semibold transition-all duration-300 ${activeSection === link.name
                    ? " text-gold-500 "
                    : "text-white/90"
                    }`}
                >
