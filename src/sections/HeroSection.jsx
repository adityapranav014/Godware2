...
const HeroSection = ({ onShopClick }) => {
  return (
    <div className="bg-black text-white min-h-[100dvh] overflow-hidden relative flex items-center justify-center">
      <section
        className="relative z-10 w-full max-w-6xl mx-auto px-6 pb-12 md:pb-16 flex flex-col items-center justify-center min-h-[100dvh]  gap-1 md:gap-8 m-8 md:m-20"
      >
        <h4 className="uppercase text-accent text-sm md:text-xl text-center mb-2 impact opacity-90">
          Your second layer of skin
        </h4>
        <div className="flex flex-col items-center justify-center gap-10 w-full">
          <div className="flex flex-col items-center justify-center gap-6 w-full">
            <div className="font-machina text-[2rem] md:text-[3rem] lg:text-[4rem] tracking-tight md:leading-[5rem] text-center">
            ...
            <p className="text-base text-sm md:text-[1.4rem] text-center font-manrope text-white/70 w-full lg:w-[70%] ">
